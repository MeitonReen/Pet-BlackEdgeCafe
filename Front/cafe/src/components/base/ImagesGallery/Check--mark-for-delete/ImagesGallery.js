  ...
  let images = [];
  images.push("../../Base/ImagesGallery/images/1.jpg");
  images.push("../../Base/ImagesGallery/images/2.jpg");
  images.push("../../Base/ImagesGallery/images/3.jpg");
  images.push("../../Base/ImagesGallery/images/4.jpg");
  images.push("../../Base/ImagesGallery/images/5.jpg");
  let currentIndex = 0;

  ($ => {
    const indicator = $("<img>").
      attr("src", "../../Base/ImagesGallery/indicators/indicator.svg").
