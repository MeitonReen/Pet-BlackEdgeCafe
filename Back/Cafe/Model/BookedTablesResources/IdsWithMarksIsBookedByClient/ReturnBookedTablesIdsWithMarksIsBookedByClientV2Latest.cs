...
{
	public class ReturnBookedTablesIdsWithMarksIsBookedByClientV2Latest : HandlerBase
	{
		...
		public ReturnBookedTablesIdsWithMarksIsBookedByClientV2Latest(CafeDatabase cafeDB)
		{
			_cafeDB = cafeDB;
		}
		...
		{
			BookedTableIdWithMarkIsBookedByClientDTO[] bookedTables = await (
				from bookedTable in _cafeDB.BookedTables
				where bookedTable.DateTimeATableIsWillBeFree > DateTime.Now
				select new BookedTableIdWithMarkIsBookedByClientDTO(
